...
while($row=mysqli_fetch_array($result))
{
	...
	<td><input type="text" name="Email" value="<?php echo $row['username']?>"readonly></td>
	<td><input type="text" name="firstname" value="<?php echo $row['name']?>"readonly></td>
	<td><input type="text" name="last name" value="<?php echo $row['lname']?>"readonly></td>
