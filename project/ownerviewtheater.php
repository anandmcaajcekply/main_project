...
$tid=$_SESSION['lid'];
//echo($tid);
$sql="select * from login,staffreg,theaterreg,screen where staffreg.theaterid=theaterreg.theaterid and screen.theaterid=theaterreg.theaterid and staffreg.lid=login.lid and login.lid=$tid";
...
while($row=mysqli_fetch_array($result))
{
	...
	<td><input type="text" name="owner" value="<?php echo $row['name']?>"readonly></td>
	...
	<td><input type="text" name="mode" value="<?php echo $row['tmode']?>"readonly></td>
	<td><input type="text" name="screen" value="<?php echo $row['noscreen']?>"readonly></td>
	<td><input type="text" name="seat" value="<?php echo $row['seatno']?>"readonly></td>
