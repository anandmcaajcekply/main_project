...
<head>
 <meta charset="UTF-8">
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/meyer-reset/2.0/reset.min.css">
      ...
      <link rel="stylesheet" href="fixed-table-header/css/style.css">
<style>
.topnav {
  overflow: hidden;
...
<div class="topnav">
  ...
  <section>
  <!--for demo wrap-->
  <h1>Add Film To Theater</h1>
  <div class="tbl-header">
    <table cellpadding="0" cellspacing="0" border="0">
      <thead>
        <tr>
          <th>PICTURE</th><th>TITLE</th><th>ACTOR</th><th>ACTRESS</th><th>PRODUCER</th><th>CATEGORY</th><th>LANGUAGE</th>
        </tr>
      </thead>
    </table>
  </div>
...
<div class="made-with-love">
  Made with
  <i>♥</i> by
  <a target="_blank" href="https://codepen.io/nikhil8krishnan">Anand S</a>
</div>
  <script src='http://cdnjs.cloudflare.com/ajax/libs/jquery/2.1.3/jquery.min.js'></script>

  

    <script  src="fixed-table-header/js/index.js"></script>
