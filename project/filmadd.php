...
header('location:index.php');
	...
	//	echo $b;
	   ...
	   if($row['filmname']=="")
	   {
		$sql="INSERT INTO `filmadd`(`filmpic`, `filmname`, `actor`, `actress`, `producer`, `category`, `language`, `reldate`,`teaser`) VALUES('$path','$b','$c','$d','$e','$i','$j','$k','$tt')";
...
<form name="treg" id="msform" method="post" action="#" enctype="multipart/form-data">
  ...
  <table>
	...
	<tr><td><input type="text" id="h3" name="producer" placeholder="Producer" onchange="l3()" required /></td></tr>
		<tr><td><textarea name="teaser" placeholder="teaser"></textarea></td></tr>
